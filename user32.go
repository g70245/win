...
var (
	...
	mapVirtualKeyExW            *windows.LazyProc
...
func init() {
	...
	mapVirtualKeyExW = libuser32.NewProc("MapVirtualKeyExW")
...
func MapVirtualKeyEx(uCode, uMapType uint32) uint {
	ret, _, _ := syscall.Syscall(mapVirtualKeyExW.Addr(), 2,
		uintptr(uCode),
		uintptr(uMapType),
		0)
	return uint(ret)
